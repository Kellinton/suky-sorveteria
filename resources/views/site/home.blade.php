            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">Sorvetes Refrescantes</h4>
                        <h1 class="mb-5 display-3 text-primary">Sabores Naturais de Sorvetes</h1>
                        {{-- <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="number" placeholder="Pesquisar Sabores">
                            <button type="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;">Fazer Busca</button>
                        </div> --}}
                    </div>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="{{ asset ('img/hero-img-1.png') }}" class="img-fluid w-100 h-100 bg-secondary rounded" alt="Primeiro slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Açai Cremoso</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="{{ asset ('img/hero-img-2.png') }}" class="img-fluid w-100 h-100 rounded" alt="Segundo slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Sorvete de Pote</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="{{ asset ('img/hero-img-3.png') }}" class="img-fluid w-100 h-100 rounded" alt="Segundo slide">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0">Experimente nossos diversos sabores de sorvetes artesanais</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0">Entregamos o seu pedido com rapidez e segurança</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                <h5>Qualidade Premiada</h5>
                                <p class="mb-0">Sorvetes feitos com ingredientes de alta qualidade e premiados</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        ...
                        <div class="p-4 rounded-bottom">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                            <div class="d-flex justify-content-between flex-lg-wrap">
                                <p class="text-dark fs-5 fw-bold mb-0">R$7.99 / UN</p>
                                <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="{{ route('contato.enviar') }}" method="POST" id="formContato">
                                @csrf
                                <input type="text" name="nomeContato" id="nomeContato" class="w-100 form-control border-0 py-3 mb-4" placeholder="Seu Nome:" value="{{ old('nomeContato') }}">
                                <div id="nomeContatoError" class="error-mensagem"></div>
                                <input type="email" name="emailContato" id="emailContato" class="w-100 form-control border-0 py-3 mb-4" placeholder="Seu Email:" value="{{ old('emailContato') }}">
                                <div id="emailContatoError" class="error-mensagem"></div>
                                <input type="text" name="foneContato" id="foneContato" class="w-100 form-control border-0 py-3 mb-4" placeholder="Seu Número (Telefone):" value="{{ old('foneContato') }}">
                                <div class="mb-4">
                                    <select name="assuntoContato" id="assuntoContato" class="form-select border-0 p-3"
                                        ...
                                        <option value="Sugestões de novos sabores">Sugestões de novos sabores</option>
                                        <option value="Outros">Outros</option>
                                    </select>
                                    <div id="assuntoContatoError" class="error-mensagem"></div>
                                </div>
                                <textarea name="mensagemContato" id="mensagemContato" class="w-100 form-control border-0 mb-4 textarea-form" rows="5" cols="10" placeholder="Sua Mensagem:">{{ old('mensagemContato') }}</textarea>
                                <div id="mensagemContatoError" class="error-mensagem"></div>
                                <input class="w-100 btn form-control border-secondary py-3 bg-white text-primary" type="submit" onclick="formContato(event)">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="d-flex p-4 rounded bg-white">
                                <i class="fa fa-calendar-alt fa-2x text-primary me-4"></i>
                                <div>
                                    <h4>Horário de funcionamento</h4>
                                    <p class="mb-2">Todos os dias / 9h às 18h</p>
                                </div>
                            </div>
                        </div>
                    </div>
