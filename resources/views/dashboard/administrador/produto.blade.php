        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-8">
                    <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Valor Total</p>
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-8">
                    <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Valor Médio</p>
                        <h5 class="font-weight-bolder mb-0">
                            R$ {{ number_format($valorMedioProdutos, 2, ',', '.') }}
                        </h5>
                    </div>
                    </div>
                    <div class="col-4 text-end">
