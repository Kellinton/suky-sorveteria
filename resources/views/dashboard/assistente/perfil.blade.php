...
@section('conteudo')
    ...
    <div class="row m-0">
        <div class="col-12 col-sm-6  py-2">
            <div class="card">
              ...
              <div class="card-body p-3">
                ...
                <form action="{{ route('assistente.perfil.update', ['id' => $funcionarioPerfil->id]) }}" method="POST"
                        ...
                        <li class="list-group-item border-0 p-0">
                            <div class="form-check form-switch ps-0">
                                <label for="tokenFuncionario" class="form-label d-flex">Token</label>
                                    <div class="d-flex align-items-center">
                                        <input type="text" class="form-control me-2" id="tokenFuncionario" name="tokenFuncionario"  value="{{ $funcionarioPerfil->token_lembrete }}" readonly>
        ...
        <div class="col-12 col-sm-6  py-2">
            <div class="card">
              ...
              <div class="card-body p-3">
                <h6 class="text-uppercase text-body text-xs font-weight-bolder mt-2">Detalhes</h6>
                <ul class="list-group">
                  <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Endereço:</strong> &nbsp; {{ $funcionarioPerfil->enderecoFuncionario }}</li>
                  <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Cidade:</strong> &nbsp; {{ $funcionarioPerfil->cidadeFuncionario }}</li>
                  ...
                  <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Data de Nascimento:</strong> &nbsp; {{ $funcionarioPerfil->dataNascFuncionario }}</li>
                  <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Data de Contrato:</strong> &nbsp; {{ $funcionarioPerfil->dataContratacaoFuncionario }}</li>
    ...
    <script>
        ...
        const token = document.getElementById('tokenFuncionario').value;
